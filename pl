...
// Silesian letters on the third and fourth level,
// by Grzegorz Kulik <poslunsku@gmail.com> and Przemysław Buczkowski <przemub@yahoo.pl>.
//
partial alphanumeric_keys
xkb_symbols "szl" {
...
// Kashubian letters on the third and fourth level.
//
partial alphanumeric_keys
xkb_symbols "csb" {
...
// Colemak-DH (ANSI), Polish variant, https://colemakmods.github.io/mod-dh/
partial alphanumeric_keys
